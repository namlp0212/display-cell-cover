-- Add H3 Res6 support: 4-tier resolution
-- Zoom 0-7   → H3 Res6 (~36.1 km²/hex) — toàn vùng rộng
-- Zoom 8-9   → H3 Res7 (~5.16 km²/hex)
-- Zoom 10-11 → H3 Res8 (~0.74 km²/hex)
-- Zoom 12+   → WMS raster (Res9 fallback, hex tiles không được request)
