...
public interface RasterCoverageRepository extends JpaRepository<RasterCoverage, Long> {
    ...
    @Query("SELECT r.cellId, r.ovlpGroup, r.avgSignal FROM RasterCoverage r WHERE r.svr = false GROUP BY r.cellId, r.ovlpGroup, r.avgSignal")
    List<Object[]> findCellRegistrationInfo();
